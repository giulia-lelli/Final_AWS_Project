...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:    # process through the results dictionary
        ...
        #           It counts how many pet images of
        #           dogs had their breed correctly classified. This happens 
        #           when the pet image label indicates the image is-a-dog AND 
        #           the pet image label and the classifier label match. We
        #           need to write a conditional statement that determines
        ...
        #           It counts how many pet images that are NOT dogs were correctly classified.
        ...
        #           I write a conditional statement that 
    ...
    #           It calculates the % of correctly matched images.
    #           Recall that this can be calculated by the
    ...
    #           It calculates the % of correctly classified dog images.
    #           Recall that this can be calculated by 
    ...
    #           It calculates the % of correctly classified breeds of dogs.
    #           Recall that this can be calculated by the number of correctly classified breeds of dog('n_correct_breed') 
    #           divided by the number of dog images('n_dogs_img'). This result 
    #           will need to be multiplied by 100.0 to provide the percentage.
